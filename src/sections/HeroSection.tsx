  ...
  return (
    <section id="hero" className="min-h-[100svh] h-auto md:h-screen bg-[#0a0a0a] flex flex-col overflow-hidden relative font-sans border-b border-white/5" style={{ willChange: 'transform' }}>
      ...
      <motion.nav
        ...
        className="absolute top-4 md:top-5 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 sm:gap-5 md:gap-7 px-3 sm:px-6 py-2 md:px-7 md:py-3 rounded-full bg-[#111111]/70 backdrop-blur-2xl border border-white/40 border-t-white/90 border-b-black/40 shadow-[0_10px_40px_rgba(0,0,0,0.9),_inset_0_2px_10px_rgba(255,255,255,0.7),_inset_0_-6px_12px_rgba(0,0,0,0.9)] text-[9px] sm:text-[10px] md:text-xs font-bold tracking-widest uppercase"
      >
